           ...
           <p>
            ...
            <div class="pt-5 mt-5">
              ...
              <ul class="comment-list">
                <li class="comment">
                  <div class="vcard bio">
                    <img src="{{ asset('img/person_2.jpg') }}" alt="Image placeholder">
                  </div>
                ...
                <li class="comment">
                  <div class="vcard bio">
                    <img src="{{ asset('img/person_3.jpg') }}" alt="Image placeholder">
                  </div>
                  <div class="comment-body">
                    <h3>John Doe</h3>
                    <div class="meta">June 27, 2018 at 2:21pm</div>
                        ...
                        <li class="comment">
                          ...
                          <div class="comment-body">
                            ...
                            <ul class="children">
                              <li class="comment">
                                <div class="vcard bio">
                                  <img src="{{ asset('img/person_4.jpg') }}" alt="Image placeholder">
                                </div>
                                <div class="comment-body">
                                  <h3>John Doe</h3>
                                  <div class="meta">June 27, 2018 at 2:21pm</div>
