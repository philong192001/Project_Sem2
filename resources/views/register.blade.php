                    ...
                    <div class="signup-form">
                        ...
                        <form action="{{ route('register.user') }}" class="register-form" id="register-form" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input class="@error('name') is-invalid @enderror" id="name" name="name" placeholder="Your Name" type="text"/>
                                @error('name')
                                <div class="warning">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <input class="@error('email') is-invalid @enderror" id="email" name="email" placeholder="Your Email" type="email"/>
                                @error('email')
                                <div class="warning">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="form-group ">
                                ...
                                <input class="@error('gender') is-invalid @enderror" id="gender" name="gender" placeholder="Your Gender" type="text"/>
                                @error('gender')
                                <div class="warning">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="form-group ">
                                ...
                                <input class="@error('address') is-invalid @enderror" id="address" name="address" placeholder="Your Address" type="text"/>
                                @error('address')
                                <div class="warning">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="form-group ">
                                ...
                                <input class="@error('district') is-invalid @enderror" id="district" name="district" placeholder="Your District" type="text"/>
                                @error('district')
                                <div class="warning">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="form-group ">
                                ...
                                <input class="@error('city') is-invalid @enderror" id="city" name="city" placeholder="Your City" type="text"/>
                                @error('city')
                                <div class="warning">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="form-group ">
                                ...
                                <input class="@error('CMTND') is-invalid @enderror" id="CMTND" name="CMTND" placeholder="Your CMTND" type="text"/>
                                @error('CMTND')
                                <div class="warning">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="form-group ">
                                ...
                                <input class="@error('phone') is-invalid @enderror" id="phone" name="phone" placeholder="Your Phone" type="text"/>
                                @error('phone')
                                <div class="warning">
                                    {{ $message }}
                                </div>
