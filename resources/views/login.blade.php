			...
			<div class="container">
				<div class="signin-content">
					<div class="signin-image">
						@if(session('alert'))
						<section class='alert alert-primary alert-dismissible' style="text-align: center">
							<h3 style="color: pink;">{{session('alert')}}<i style="margin-left: 5px;color: red;" class="fas fa-heart"></i></h3>
						</section>
						@endif
